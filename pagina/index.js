...
import { bind, unbind } from 'eventwheel';
...
Rotation.prototype.scroll = function (n) {
  ...
  if (this._scroll) {
    bind(this.el, this.onWheel);
  } else {
    unbind(this.el, this.onWheel);
  }
...
Rotation.prototype.bind = function () {
  ...
  if (this._scroll) bind(this.el, this.onWheel);
};
...
Rotation.prototype.unbind = function () {
  ...
  if (this._scroll) unbind(this.el, this.onWheel);
};
